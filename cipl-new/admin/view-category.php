                    ...
                    <div class="span12">                    
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="example">
                             ...
                             <input type="hidden" id="tbl" name="tbl" value="category" />

                             <input type="hidden" id="update" name="update" value="edit-category.php" />
...
function format ( d ) {
	...
	'<tr><th width="100%" colspan="6"><center>Category Detail</center></th></tr>'+

	'<tr><th width="10%">Category Name</th><td width="23%" colspan="2">'+d[1]+'</td><th width="10%">Location</th><td width="23%" colspan="2">'+d[2]+'</td></tr>'+

	'<tr><th width="10%">Image</th><td width="85%" colspan="6"><div style="display: flex;">';
  ...
  tbl+='<div style="display: grid; margin-right: 15px;"><img src="php/files/thumbnail/'+value+'" width="150px;"><a class="btn remove_image" style="width: 60%; margin: 10px auto;" data-attr-id="'+value+'"><span class=" isw-delete"></span>Delete</a></div>';
	...
	'</td><th width="10%">Created On</th><td width="23%" colspan="2">'+d[5]+'</td></tr>'+
...
$(document).ready(function() {
    ...
    var t = $('#example').DataTable( {
		...
		"ajax": "scripts/view-category.php",
	   ...
	   "columnDefs": 
        ...
        {
		 "render": function ( data, type, row ) { return type === 'display' && data.length > 40 ?'<span title="'+data+'">'+data.substr( 0, 38 )+'...</span>' : data; },
		 "targets": 1,"data":1  
		 },
		 {
		 "render": function ( data, type, row ) { return type === 'display' && data.length > 40 ?'<span title="'+data+'">'+data.substr( 0, 38 )+'...</span>' : data; },
		 ...
		 
		 {
          ...
          },
		  {
				...
				"render": function ( data, type, full, meta ) 
				{
return '<i class="isb-plus details-control"  title="View Detail" style="cursor:pointer;"></i><i class="isb-edit edit"  style="cursor:pointer;padding-left:15px;" title="Edit Category"></i>';
				}  
            }
		],
...
var detailRows = [];
 ...
 t.on( 'draw', function () {
	...
	$(document).on("click", ".remove_image", function(){
		var qw = $(this).data("attr-id"); 
		
		$.post('php/',{'caseno': btoa(26),'link':qw}, function(data){
