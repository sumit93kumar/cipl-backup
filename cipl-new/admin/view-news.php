...
<th width="12%">Added On</th>
                             ...
                             <input type="hidden" id="update" name="update" value="edit-news.php" />
...
function format ( d ) {
	...
	'<tr><th width="10%">Title</th><td width="23%" colspan="2">'+d[1]+'</td><th width="10%">Description</th><td width="23%" colspan="2">'+d[2]+'</td></tr>'+

	'<tr><th width="10%">Author</th><td width="23%" colspan="2">'+d[3]+'</td><th width="10%">Created On</th><td width="23%" colspan="2">'+d[5]+'</td></tr>'+
