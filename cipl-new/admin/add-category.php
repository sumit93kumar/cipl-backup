...
<body>
    <div class="wrapper"> 
		...
		<div class="content">
			...
			<div id="msg">
                ...
                <div class="page-header">
                    <h1>Add Category <!---<small>Category</small>---></h1>
                </div>  
                ...
                <div class="span10">
						...
						<input type="hidden" id="caseno" name="caseno" value="<?php echo base64_encode('1');?>">
                            
                            <div class="row-form clearfix">
                                <div class="span3">Category:</div>
                                <div class="span9">        
                                    <input value="" class="validate[required]" type="text" name="category" id="category"/>
							...
							<div class="row-form clearfix">
                                ...
                                <div class="span9">        
                                    <input value="" class="validate[required]" type="text" name="location" id="location"/>
		...
		<input type="hidden" id="description" name="description" value="<?php echo base64_encode($_SESSION['uid'])?>" />
          <input type="hidden" id="title" name="title" value="<?php echo base64_encode(str_shuffle(time()))?>" />
