		...
		<div class="content">
			...
			<div id="msg">
                ...
                <div class="page-header">
                    <h1>Add Subcategory <!---<small>Category</small>---></h1>
                </div>  
                ...
                <div class="span12">
						...
						<input type="hidden" id="caseno" name="caseno" value="<?php echo base64_encode('2');?>">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span9">        
                                    <input value="" class="validate[required]" type="text" name="sub_category" id="sub_category"/>
