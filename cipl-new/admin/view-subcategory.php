        ...
        <div class="content">
            ...
            <div class="breadLine">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Subcategory<span class="divider">></span></li>
                    ...
                    <div class="span12">                    
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="example">
                             ...
                             <input type="hidden" id="tbl" name="tbl" value="subcategory" />

                             <input type="hidden" id="update" name="update" value="edit-subcategory.php" />
...
function format ( d ) {
	...
	'<tr><th width="100%" colspan="6"><center>Subcategory Detail</center></th></tr>'+

	'<tr><th width="10%">Subcategory Name</th><td width="23%" colspan="2">'+d[1]+'</td><th width="10%">Created On</th><td width="23%" colspan="2">'+d[4]+'</td></tr>'+

	'<tr><th width="10%">Gallery Images</th><td width="90%" colspan="6"><div style="display: flex;">';
...
$(document).ready(function() {
    ...
    var t = $('#example').DataTable( {
		...
		"ajax": "scripts/view-subcategory.php",
...
var detailRows = [];
 ...
 t.on( 'draw', function () {
	...
	$(document).on("click", ".remove_image", function(){
		...
		$.post('php/',{'caseno': btoa(25),'link':qw}, function(data){
